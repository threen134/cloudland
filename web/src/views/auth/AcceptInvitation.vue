            ...
            <div class="card invitation-card">
                ...
                <div v-else-if="status === 'info' || status === 'accepting'" class="state-content">
                    ...
                    <div v-else class="existing-user-info">
                        <p
                            v-html="
                                $t('acceptInvitation.existingUser', {
                ...
                <div v-else-if="status === 'success'" class="state-content success">
                    ...
                    <p
                        class="status-desc"
                        v-html="
                            $t('acceptInvitation.successJoined', {
                                orgName: `<strong>${invitationInfo?.org_name}</strong>`,
                            })
                        "
                    ></p>
...
.auth-page {
    ...
    background:
        radial-gradient(circle at 20% 20%, var(--primary-50) 0%, transparent 40%),
        radial-gradient(circle at 80% 80%, var(--primary-100) 0%, transparent 40%), var(--bg-secondary);
    position: relative;
    overflow: hidden;
