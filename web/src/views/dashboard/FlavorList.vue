                    ...
                    <div class="resource-info">
                        ...
                        <div>
                            ...
                            <div class="resource-id-row">
                                <span class="resource-id" :title="flavor.uuid"
                                    >{{ (flavor.uuid || '').slice(0, 8) }}...</span
                                >
                                <button
                                    class="copy-btn-mini"
                                    @click.stop.prevent="flavor.uuid && copyId(flavor.uuid)"
                                    :title="t('actions.copy')"
                                    :aria-label="t('actions.copy')"
                                >
                                    <Check
                                        v-if="copiedId === flavor.uuid"
                                        :size="10"
        ...
        >
            <div class="form-grid">
                ...
                <div class="form-row">
                    <div class="form-group flex-1">
                        ...
                        <div class="input-with-unit">
                            <input v-model.number="newFlavorForm.cpu" type="number" class="form-input" min="1" />
                    ...
                    <div class="form-group flex-1">
                        ...
                        <div class="input-with-unit">
                            <input v-model.number="newFlavorForm.memory" type="number" class="form-input" min="16" />
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-unit">
                        <input v-model.number="newFlavorForm.disk" type="number" class="form-input" min="1" />
