    ...
    <div>
                    ...
                    <div class="resource-info">
                        ...
                        <div>
                            ...
                            <div class="resource-id-row">
                                ...
                                <button
                                    class="copy-btn-mini"
                                    @click.stop.prevent="copyId(org.uuid)"
                                    :title="t('actions.copy')"
                                    :aria-label="t('actions.copy')"
                                >
                                    <Check
                                        v-if="copiedId === org.uuid"
                                        :size="10"
            ...
            <template #cell-owner="{ row: org }">
                ...
                <div class="owner-cell" v-else-if="org.owner_uuid">
                    ...
                    <div class="resource-id-row">
                        ...
                        <button
                            class="copy-btn-mini"
                            @click.stop.prevent="copyId(org.owner_uuid)"
                            :title="t('actions.copy')"
                            :aria-label="t('actions.copy')"
                        >
        ...
        <BaseModal :show="quotaModalVisible" size="xl" @close="closeQuotaModal">
            ...
            <div v-else-if="quotaError" class="text-center" style="padding: 24px">
                ...
                <button class="btn btn-secondary btn-sm" @click="fetchQuota(quotaOrgId)">
                    {{ $t('actions.retry') }}
                </button>
            </div>
            ...
            <template #footer>
                <button class="btn btn-secondary" @click="closeQuotaModal">
