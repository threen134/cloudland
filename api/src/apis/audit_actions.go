...
var auditRoutes = map[string]auditRoute{
	...
	"PUT /volumes/:id/qos":     {"volume", "volume.qos", "id", false},

	"POST /backups":             {"backup", "backup.create", "", false},
	"DELETE /backups/:id":       {"backup", "backup.delete", "id", false},
	"POST /backups/:id/restore": {"backup", "backup.restore", "id", false},

	"POST /consistency_groups":                                {"consistency_group", "consistency_group.create", "", false},
	"PATCH /consistency_groups/:id":                           {"consistency_group", "consistency_group.update", "id", false},
	"DELETE /consistency_groups/:id":                          {"consistency_group", "consistency_group.delete", "id", false},
	"POST /consistency_groups/:id/volumes":                    {"consistency_group", "consistency_group.volume_add", "id", false},
	"DELETE /consistency_groups/:id/volumes/:volume_id":       {"consistency_group", "consistency_group.volume_remove", "id", false},
	"POST /consistency_groups/:id/snapshots":                  {"consistency_group", "consistency_group.snapshot_create", "id", false},
	"DELETE /consistency_groups/:id/snapshots/:snap_id":       {"consistency_group", "consistency_group.snapshot_delete", "id", false},
	"POST /consistency_groups/:id/snapshots/:snap_id/restore": {"consistency_group", "consistency_group.snapshot_restore", "id", false},
...
var auditNameColumns = map[string][2]string{
	...
	"image":             {"images", "name"},
	"volume":            {"volumes", "name"},
	"backup":            {"volume_backups", "name"},
	"consistency_group": {"consistency_groups", "name"},
}
