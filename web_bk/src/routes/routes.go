...
func New() (m *macaron.Macaron) {
	...
	m.Get("/hypers/:uuid/edit", hyperView.Edit)
	m.Post("/hypers/:uuid/edit", hyperView.Patch)
	m.Get("/hypers/:uuid/set_status", hyperView.SetHyperStatus)
	m.Post("/hypers/:uuid/maintain", hyperView.Maintain)
